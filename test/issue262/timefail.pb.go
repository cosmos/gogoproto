...
var fileDescriptor_395e61815f86626a = []byte{
	...
	0x8b, 0xf5, 0xd3, 0xf3, 0xd3, 0xf3, 0xc1, 0xca, 0xd0, 0x58, 0x10, 0xbd, 0x52, 0xf2, 0xe9, 0xf9,
	0xf9, 0xe9, 0x39, 0xa9, 0xfa, 0x60, 0x5e, 0x52, 0x69, 0x9a, 0x3e, 0xc8, 0xac, 0xe2, 0x92, 0xc4,
	0xdc, 0x02, 0x88, 0x02, 0x25, 0x4f, 0x2e, 0x8e, 0x90, 0xcc, 0xdc, 0x54, 0xb7, 0xc4, 0xcc, 0x1c,
	0x21, 0x5b, 0x2e, 0x4e, 0x90, 0x74, 0x7c, 0x49, 0x6a, 0x71, 0x89, 0x04, 0xa3, 0x02, 0xa3, 0x06,
	0xb7, 0x91, 0x94, 0x1e, 0xc4, 0x00, 0x3d, 0x98, 0x01, 0x7a, 0x21, 0x30, 0x03, 0x9c, 0x58, 0x26,
	0xdc, 0x97, 0x67, 0x0c, 0x02, 0xbb, 0x2e, 0x24, 0xb5, 0xb8, 0xc4, 0xc9, 0xe4, 0xc2, 0x43, 0x39,
	...
	0xe3, 0xb1, 0x1c, 0x43, 0x12, 0x1b, 0xd8, 0x64, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x14,
	0xf5, 0xa6, 0x99, 0xf6, 0x00, 0x00, 0x00,
}
...
func (m *TimeFail) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.TimeTest != nil {
		n1, err1 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(*m.TimeTest, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(*m.TimeTest):])
		if err1 != nil {
			return 0, err1
		}
		i -= n1
...
func (m *TimeFail) Size() (n int) {
	...
	_ = l
	if m.TimeTest != nil {
		l = github_com_cosmos_gogoproto_types.SizeOfStdTime(*m.TimeTest)
...
func (m *TimeFail) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := github_com_cosmos_gogoproto_types.StdTimeUnmarshal(m.TimeTest, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
